...
\item {\bf (2.5 pontos)} Considere o seguinte jogo em um grafo
  ...
  \resposta{
	...
	Pode-se mostrar que é possível construir ham-cycles a partir desse problema, já que, como foi mostrado que o ham-cycle é um np completo, a redução correta do ham-cycle mostra que esse problema também é np completo. Assim:
